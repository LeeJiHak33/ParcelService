...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="/question/resources/css/qusdet.css" type="text/css">
<title>자주 묻는 질문 상세 페이지</title>
<style>
</style>
</head>
<body>
	<div class="back" style="background-image: url('/question/resources/images/bg_header_enterprise.png');">
		<div class="header">
		<h1 class="logo">
				<a href="/"><img
					style="width: 105px; height: 75px; position: absolute; right: 1370px; top: 10px;"
					src="/question/resources/images/logo2.png"></a>
			</h1>
